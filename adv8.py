...
for m in range(len(signal_output_list)):
    ...
    for i in range(len(signal_output_list[m][0])):
        if len(signal_output_list[m][0][i])==5:
            #2 or 3 or 5
            if all(num in sorted(signal_output_list[m][0][i]) for num in sorted(unique_signal_patterns[1])):
                unique_signal_patterns[3]=signal_output_list[m][0][i]
            elif all(num in sorted(signal_output_list[m][0][i]) for num in sorted(''.join(list(set(unique_signal_patterns[4])-set(unique_signal_patterns[1]))))):
    ...
    for i in range(len(signal_output_list[m][0])):
        if len(signal_output_list[m][0][i])==6:
            #0 or 6 or 9
            if all(num in sorted(signal_output_list[m][0][i]) for num in sorted(unique_signal_patterns[4])):
                unique_signal_patterns[9]=signal_output_list[m][0][i]
            elif all(num in sorted(signal_output_list[m][0][i]) for num in sorted(''.join(list(set(unique_signal_patterns[8])-set(unique_signal_patterns[1]))))):
